...
/**
 * The entity of impasse_requirement_cases as TABLE. <br />
 * <pre>
 * [primary-key]
 *     id
 * 
 ...
 * Integer requirementId = entity.getRequirementId();
 ...
 */
public abstract class BsImpasseRequirementCases implements Entity,
    ...
    protected Integer _requirementId;
    ...
    public String getTablePropertyName() { // according to Java Beans rule
        return "impasseRequirementCases";
    }
    ...
    public boolean equals(final Object other) {
        if (other == null || !(other instanceof BsImpasseRequirementCases)) {
            return false;
        }
        final BsImpasseRequirementCases otherEntity = (BsImpasseRequirementCases) other;
    ...
    protected String buildColumnString() {
        ...
        sb.append(delimiter).append(getRequirementId());
     ...
     */
    @Override
    public ImpasseRequirementCases clone() {
        try {
            return (ImpasseRequirementCases) super.clone();
    ...
    /**
     * [get] requirement_id: {NotNull, INT(10)} <br />
     * @return The value of the column 'requirement_id'. (NullAllowed)
     */
    ...
    /**
     * [set] requirement_id: {NotNull, INT(10)} <br />
     * @param requirementId The value of the column 'requirement_id'. (NullAllowed)
     */
    public void setRequirementId(final Integer requirementId) {
        __modifiedProperties.addPropertyName("requirementId");
        _requirementId = requirementId;
    }

    /**
     * [get] test_case_id: {NotNull, INT(10)} <br />
    ...
    /**
     * [set] test_case_id: {NotNull, INT(10)} <br />
