...
/**
 * The abstract condition-query of impasse_executions.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsImpasseExecutionsCQ extends
        AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsImpasseExecutionsCQ(final ConditionQuery childQuery,
     ...
     * status: {VARCHAR(255), default=[0]}
     */
    public void setStatus_IsNullOrEmpty() {
        regStatus(CK_ISNOE, DOBJ);
    }
     ...
     * execution_ts: {IX, DATETIME(19)}
     */
    public void setExecutionTs_IsNull() {
        regExecutionTs(CK_ISN, DOBJ);
    }
     ...
     * execution_ts: {IX, DATETIME(19)}
     */
    public void setExecutionTs_IsNotNull() {
        regExecutionTs(CK_ISNN, DOBJ);
    }
     ...
     * executor_id: {INT(10)}
     */
    public void setExecutorId_IsNull() {
        regExecutorId(CK_ISN, DOBJ);
    }
     ...
     * executor_id: {INT(10)}
     */
    public void setExecutorId_IsNotNull() {
        regExecutorId(CK_ISNN, DOBJ);
    }
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_Equal()</span>.max(new SubQuery&lt;ImpasseExecutionsCB&gt;() {
     *     public void query(ImpasseExecutionsCB subCB) {
     ...
     */
    public HpSSQFunction<ImpasseExecutionsCB> scalar_Equal() {
     ...
     * {where FOO &lt;&gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_NotEqual()</span>.max(new SubQuery&lt;ImpasseExecutionsCB&gt;() {
     *     public void query(ImpasseExecutionsCB subCB) {
     *         subCB.specify().setXxx... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setYyy...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ImpasseExecutionsCB> scalar_NotEqual() {
     ...
     * {where FOO &gt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterThan()</span>.max(new SubQuery&lt;ImpasseExecutionsCB&gt;() {
     *     public void query(ImpasseExecutionsCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ImpasseExecutionsCB> scalar_GreaterThan() {
     ...
     * {where FOO &lt; (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessThan()</span>.max(new SubQuery&lt;ImpasseExecutionsCB&gt;() {
     *     public void query(ImpasseExecutionsCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ImpasseExecutionsCB> scalar_LessThan() {
     ...
     * {where FOO &gt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_GreaterEqual()</span>.max(new SubQuery&lt;ImpasseExecutionsCB&gt;() {
     *     public void query(ImpasseExecutionsCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ImpasseExecutionsCB> scalar_GreaterEqual() {
     ...
     * {where FOO &lt;= (select max(BAR) from ...)
     * <pre>
     * cb.query().<span style="color: #FD4747">scalar_LessEqual()</span>.max(new SubQuery&lt;ImpasseExecutionsCB&gt;() {
     *     public void query(ImpasseExecutionsCB subCB) {
     *         subCB.specify().setFoo... <span style="color: #3F7E5E">// derived column for function</span>
     *         subCB.query().setBar...
     *     }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSSQFunction<ImpasseExecutionsCB> scalar_LessEqual() {
        return xcreateSSQFunction(CK_LE.getOperand());
    }

    protected HpSSQFunction<ImpasseExecutionsCB> xcreateSSQFunction(
            final String operand) {
        return new HpSSQFunction<ImpasseExecutionsCB>(
                new HpSSQSetupper<ImpasseExecutionsCB>() {
                    @Override
                    public void setup(final String function,
                            final SubQuery<ImpasseExecutionsCB> subQuery,
                            final HpSSQOption<ImpasseExecutionsCB> option) {
    ...
    protected void xscalarCondition(final String function,
            final SubQuery<ImpasseExecutionsCB> subQuery, final String operand,
            final HpSSQOption<ImpasseExecutionsCB> option) {
        assertObjectNotNull("subQuery<ImpasseExecutionsCB>", subQuery);
        final ImpasseExecutionsCB cb = xcreateScalarConditionCB();
        subQuery.query(cb);
    ...
    public abstract String keepScalarCondition(ImpasseExecutionsCQ subQuery);

    protected ImpasseExecutionsCB xcreateScalarConditionCB() {
        final ImpasseExecutionsCB cb = new ImpasseExecutionsCB();
        cb.xsetupForScalarCondition(this);
        return cb;
    }

    protected ImpasseExecutionsCB xcreateScalarConditionPartitionByCB() {
        final ImpasseExecutionsCB cb = new ImpasseExecutionsCB();
    ...
    public abstract String keepSpecifyMyselfDerived(ImpasseExecutionsCQ subQuery);

    /**
     * Prepare for (Query)MyselfDerived (SubQuery).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<ImpasseExecutionsCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived();
    }

    protected HpQDRFunction<ImpasseExecutionsCB> xcreateQDRFunctionMyselfDerived() {
        return new HpQDRFunction<ImpasseExecutionsCB>(
                new HpQDRSetupper<ImpasseExecutionsCB>() {
                    @Override
                    public void setup(final String function,
                            final SubQuery<ImpasseExecutionsCB> subQuery,
    ...
    public abstract String keepQueryMyselfDerived(ImpasseExecutionsCQ subQuery);
     ...
     */
    public void myselfExists(final SubQuery<ImpasseExecutionsCB> subQuery) {
        assertObjectNotNull("subQuery<ImpasseExecutionsCB>", subQuery);
        final ImpasseExecutionsCB cb = new ImpasseExecutionsCB();
    ...
    public abstract String keepMyselfExists(ImpasseExecutionsCQ subQuery);
     ...
     * @param subQuery The implementation of sub query. (NotNull)
     */
    public void myselfInScope(final SubQuery<ImpasseExecutionsCB> subQuery) {
        assertObjectNotNull("subQuery<ImpasseExecutionsCB>", subQuery);
        final ImpasseExecutionsCB cb = new ImpasseExecutionsCB();
    ...
    public abstract String keepMyselfInScope(ImpasseExecutionsCQ subQuery);
