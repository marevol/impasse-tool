...
/**
 * The entity of impasse_execution_histories as TABLE. <br />
 * <pre>
 * [primary-key]
 *     id
 * 
 ...
 */
public abstract class BsImpasseExecutionHistories implements Entity,
    ...
    public String getTablePropertyName() { // according to Java Beans rule
        return "impasseExecutionHistories";
    }
    ...
    public boolean equals(final Object other) {
        if (other == null || !(other instanceof BsImpasseExecutionHistories)) {
            return false;
        }
        final BsImpasseExecutionHistories otherEntity = (BsImpasseExecutionHistories) other;
     ...
     */
    @Override
    public ImpasseExecutionHistories clone() {
        try {
            return (ImpasseExecutionHistories) super.clone();
    ...
    /**
     * [get] status: {NotNull, VARCHAR(255)} <br />
    ...
    /**
     * [set] status: {NotNull, VARCHAR(255)} <br />
    ...
    /**
     * [get] execution_ts: {NotNull, DATETIME(19)} <br />
    ...
    /**
     * [set] execution_ts: {NotNull, DATETIME(19)} <br />
    ...
    /**
     * [get] executor_id: {NotNull, INT(10)} <br />
    ...
    /**
     * [set] executor_id: {NotNull, INT(10)} <br />
