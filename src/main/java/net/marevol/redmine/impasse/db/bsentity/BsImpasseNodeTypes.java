...
/**
 * The entity of impasse_node_types as TABLE. <br />
 * <pre>
 * [primary-key]
 *     id
 * 
 ...
 */
public abstract class BsImpasseNodeTypes implements Entity, Serializable,
        Cloneable {
    ...
    public boolean equals(final Object other) {
        if (other == null || !(other instanceof BsImpasseNodeTypes)) {
            return false;
        }
        final BsImpasseNodeTypes otherEntity = (BsImpasseNodeTypes) other;
     ...
     */
    @Override
    public ImpasseNodeTypes clone() {
        try {
            return (ImpasseNodeTypes) super.clone();
    ...
    /**
     * [get] description: {VARCHAR(255)} <br />
    ...
    /**
     * [set] description: {VARCHAR(255)} <br />
